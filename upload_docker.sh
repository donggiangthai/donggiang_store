...
# Declare readonly variable, taking value from command line
# Usage: upload_docker.sh <tag_key>
# Example: upload_docker.sh v1.0.1
declare -r tag_key="$1"; shift
...
cloud_image_tag="$docker_path/donggiang_store:$tag_key"
